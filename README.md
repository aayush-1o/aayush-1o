...
> I turn complex problems into clean, elegant software. I build API-driven platforms and developer tooling — the kind of software other engineers actually rely on.

- 🎓 **B.Tech CSE** student based in **Bangalore, India**
- 🔭 Currently exploring **distributed systems**, **stream processing**, and **graph databases**
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>AI-driven knowledge graph platform for semantic data exploration. Leverages NLP, Neo4j, and interactive visualization to map relationships across unstructured data.</p>
      <p>
    ...
    <td width="50%" valign="top">
      ...
      <p>Automate developer onboarding at scale. Paste a GitHub URL, and get a fully configured, working Docker environment spun up in minutes — zero manual setup.</p>
      <p>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Python-based benchmark system for evaluating AutoPrompt pipelines using Google Gemini AI. Designed for reproducible, structured LLM performance assessment.</p>
      <p>
        <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white"/>
    ...
    <td width="50%" valign="top">
      ...
      <p>Modern freight and logistics dashboard with a clean, modular frontend architecture. Emphasis on UX clarity and scalable component design.</p>
      <p>
